...
const DataTable = ({ data }: DataTableProps) => {
  ...
  const handleStatusChange = async (index: number, newStatus: string) => {
    ...
    await supabase
      ...
      .eq("Surname", data[index].Surname)
      .eq("otherName", data[index].otherName)
      .eq("Passportnumber", data[index].Passportnumber)
      .eq("type_of_travel_document", data[index].type_of_travel_document);
